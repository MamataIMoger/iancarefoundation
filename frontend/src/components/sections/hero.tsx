...
export default function Hero() {
  const AnimatedCounter = ({ target, label }) => {
    ...
    return (
      <div className="text-center">
        <div className="text-4xl md:text-5xl font-extrabold text-white mb-2">{count.toLocaleString()}+</div>
  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden">
      ...
      {/* contrast overlay */}
      <div className="absolute inset-0" style={{ background: "linear-gradient(180deg, rgba(3,7,18,0.28), rgba(3,7,18,0.6))" }} />

      {/* Left aligned hero content */}
      <div className="relative z-10 container mx-auto px-6 md:px-12 lg:px-20 py-20 md:py-28">
        <div className="max-w-3xl text-left">
          {/* small welcome line in Amarante, single line */}
   <span
...
>
  WELCOME TO IAN CARES FOUNDATION
          ...
          {/* big Playfair heading (left aligned) */}
        <h1
...
>
  At Ian Cares Foundation, we believe every life deserves a second chance. We walk beside individuals
  struggling with addiction, depression, and emotional distress — guiding them toward healing, hope, and
  happiness.
</p>
...
>
  ...
  <ArrowRight size={18} />
      ...
      {/* Stats row centered across the width (near bottom of hero) */}
     {/* === Stats Section (Styled like Ganaa) === */}
  ...
  <div className="max-w-6xl mx-auto px-6 md:px-12 py-12 md:py-16 border-t border-white/10">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 text-center text-white">
      ...
      <div className="flex flex-col items-center md:items-center">
        ...
        <div className="text-4xl font-semibold">210,000+</div>
        <div className="text-white/80 mt-1 text-lg">Lives Touched</div>
      </div>
      ...
      <div className="flex flex-col items-center border-t md:border-t-0 md:border-l md:border-r border-white/10 py-8 md:py-0">
        ...
        <div className="text-white/80 mt-1 text-lg">Expert Care</div>
      </div>
      ...
      <div className="flex flex-col items-center md:items-center">
        ...
        <div className="text-white/80 mt-1 text-lg">Private & Secure</div>
      </div>
    </div>
  </div>
</div>
