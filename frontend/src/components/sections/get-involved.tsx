...
const VolunteerForm: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <label
        htmlFor="dob"
        className="block font-medium text-gray-700 mt-2 mb-1"
      >
        Date of Birth
      </label>
      <input
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2 text-sm">
          {["Mornings", "Afternoons", "Evenings", "Weekdays", "Weekends", "OneTime"].map(
            (opt) => (
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="w-full py-3 px-4 rounded-xl bg-yellow-500 text-white font-bold"
      >
              ...
              >
                <div className="flex gap-6 items-start">
                  ...
                  <div className="flex-1">
                    <h3 className="text-2xl font-bold text-[#0f86bf]">{w.title}</h3>
